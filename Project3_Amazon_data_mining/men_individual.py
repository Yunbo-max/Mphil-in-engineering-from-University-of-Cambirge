...
ax1.text(x=0.12, y=.93, s="Top Five Selling Styles of Men's underwear in UK", transform=fig.transFigure, ha='left', fontsize=26, weight='bold', alpha=.8)
ax1.text(x=0.12, y=.90, s="Based on Amazon sales data for men's underwear", transform=fig.transFigure, ha='left', fontsize=20, alpha=.8)
