...
ax3 = sns.barplot(x='Name',y='Score', data = bra, color='steelblue')
ax3.set_xticklabels(labels = ['Seamless Bra', 'Padded Bra', 'Sports Bra', 'Push-up Bra', 'Strapless Bra'], fontsize = 16)
ax3.set(xlabel=None)
ax3.set(ylabel=None)
...
ax3.set_ylabel('Score', fontsize=16, labelpad=10)
...
ax3.plot([0.12, .9], [.98, .98], transform=fig.transFigure, clip_on=False, color='#E3120B', linewidth=.6)
ax3.add_patch(plt.Rectangle((0.12,.98), 0.04, -0.02, facecolor='#E3120B', transform=fig.transFigure, clip_on=False, linewidth = 0))

# Add in title and subtitle
ax3.text(x=0.12, y=.93, s="Top Five Selling Styles of Women's Bra in UK", transform=fig.transFigure, ha='left', fontsize=26, weight='bold', alpha=.8)
ax3.text(x=0.12, y=.90, s="Based on Amazon sales data for women's bra", transform=fig.transFigure, ha='left', fontsize=20, alpha=.8)
...
# Plot bars
bar1 = ax3.bar(bra['Name'], bra['Score'], color=cmap(norm(men['Score'])), width=0.8, zorder=2)
