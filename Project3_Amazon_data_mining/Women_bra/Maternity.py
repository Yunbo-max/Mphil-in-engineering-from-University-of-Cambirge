...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Maternity-Nursing-Bras/zgbs/fashion/1731424031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
MenOverall_csv_data = data.to_csv('Womenbra_maternity.csv', index = True)
