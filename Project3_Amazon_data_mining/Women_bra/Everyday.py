...
# bandeau(5/50)、Bralette(7/50)、Plunge(4/50),Racerback(1/50),seamless(6/50),padded(18/50)
...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Everyday-Bras/zgbs/fashion/1731375031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
MenOverall_csv_data = data.to_csv('Womenbra_everyday.csv', index = True)
