...
page = 1
while page != 4:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Bras/zgbs/fashion/1731373031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
Review_score=Review_score[0:88]
Review_number=Review_number[0:88]
Rank=Rank[0:88]
...
MenOverall_csv_data = data.to_csv('Womenbra_Overall.csv', index = True)
