...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Bra-Minimizers/zgbs/fashion/14072537031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
    ...
    Price.insert(18,25)
    Price.insert(-2,30)
    Name.insert(-2,'Delimira Womens Full Cup Underwired Seamless Plus Size Minimizer Bra')
    Name.insert(18,'DotVol Womens Minimizer Strapless Bra Seamless Bandeau Unlined Underwire for Large Bust')
...
MenOverall_csv_data = data.to_csv('Womenbra_minimizers.csv', index = True)
