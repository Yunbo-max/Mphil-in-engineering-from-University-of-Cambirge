# https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Adhesive-Bras/zgbs/fashion/1731374031/ref=zg_bs_pg_1?_encoding=UTF8&pg=1

# https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Everyday-Bras/zgbs/fashion/1731375031/ref=zg_bs_pg_1?_encoding=UTF8&pg=1

# https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Bras/zgbs/fashion/1731373031/ref=zg_bs_nav_fashion_5_1731363031

# push-up,stick on,strapless
...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Adhesive-Bras/zgbs/fashion/1731374031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
MenOverall_csv_data = data.to_csv('Womenbra_addhesive.csv', index = True)
