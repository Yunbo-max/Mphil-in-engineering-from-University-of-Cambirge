...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Sports-Bras/zgbs/fashion/1731339031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
MenOverall_csv_data = data.to_csv('Womenbra_sports.csv', index = True)
