...
ax1 = sns.barplot(x='Name',y='Score', data = men, color='steelblue',ax=axes[0])
ax1.set(xlabel=None)
ax1.set(ylabel=None)

ax2 = sns.barplot(x='Name',y='Score', data = women, color='steelblue',ax=axes[1])
ax2.set(xlabel=None)
ax2.set(ylabel=None)
...
ax1.set_ylabel('Score', fontsize=12, labelpad=10)
ax2.set_ylabel('Score', fontsize=12, labelpad=10)
...
ax1.plot([0.12, .9], [.98, .98], transform=fig.transFigure, clip_on=False, color='#E3120B', linewidth=.6)
ax1.add_patch(plt.Rectangle((0.12,.98), 0.04, -0.02, facecolor='#E3120B', transform=fig.transFigure, clip_on=False, linewidth = 0))

# Add in title and subtitle
ax1.text(x=0.12, y=.93, s="Top Five Selling Styles of Underwears and Bras in UK", transform=fig.transFigure, ha='left', fontsize=14, weight='bold', alpha=.8)
ax1.text(x=0.12, y=.90, s="Based on Amazon sales data for men's underwear and women's underwear and bras", transform=fig.transFigure, ha='left', fontsize=12, alpha=.8)
...
# Plot bars
bar1 = ax1.bar(men['Name'], men['Score'], color=cmap(norm(men['Score'])), width=0.8, zorder=2)
