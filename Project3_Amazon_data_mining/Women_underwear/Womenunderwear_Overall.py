# amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Knickers/zgbs/fashion/1731380031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
Review_score=Review_score[0:87]
Review_number=Review_number[0:87]
Rank=Rank[0:87]
...
MenOverall_csv_data = data.to_csv('Womenunderwear_Overall.csv', index = True)
