...
page = 1
while page != 2:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Womens-Bikini-Briefs/zgbs/fashion/1731383031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
MenOverall_csv_data = data.to_csv('Women_Bikini&Briefs.csv', index = True)
