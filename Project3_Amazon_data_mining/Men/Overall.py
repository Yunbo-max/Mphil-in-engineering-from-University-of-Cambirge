...
page = 1
while page != 4:
    amazon_url = f"https://www.amazon.co.uk/Best-Sellers-Fashion-Mens-Underwear/zgbs/fashion/1731031031/ref=zg_bs_pg_1?_encoding=UTF8&pg={page}"
...
Review_score=Review_score[0:89]
Review_number=Review_number[0:89]
Rank=Rank[0:89]
...
MenOverall_csv_data = data.to_csv('men_Overallfianl.csv', index = True)
